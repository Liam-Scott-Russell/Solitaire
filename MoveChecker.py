class MoveChecker:
    ...
    def check_move(column1, column2, gamestate):
        ...
        if should_check_condition_1:
            ...
            return MoveChecker.check_condition_2(gamestate, column2)
        else:
            return False
    ...
    @staticmethod
    def check_condition_2(gamestate, column2):
        first_card_deque = gamestate.columns[0]
        ...
        if is_items_in_first_column and is_items_in_second_column:
